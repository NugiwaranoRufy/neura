...
fun SettingsScreen(
    ...
    val tiles = listOf(
        ...
        SettingsTile("Training plan", "Open your adaptive weekly coach.", icon = "🧭", onOpenTrainingPlan),
        SettingsTile("Missions", "Review your weekly objectives.", icon = "✅", onOpenMissions),
        SettingsTile("Badges", "Review your unlocked milestones.", icon = "🏅", onOpenBadges),
