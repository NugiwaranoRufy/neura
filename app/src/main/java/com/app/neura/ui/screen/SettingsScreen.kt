...
fun SettingsScreen(
    ...
    val tiles = listOf(
        ...
        SettingsTile("Training plan", "Open your adaptive weekly coach.", icon = "🧭", onOpenRecords),
        SettingsTile("Missions", "Review your weekly objectives.", icon = "✅", onOpenRecords),
        SettingsTile("Badges", "Review your unlocked milestones.", icon = "🏅", onOpenRecords),
