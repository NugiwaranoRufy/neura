...
import com.app.neura.ui.component.NeuraBottomBar
...
import com.app.neura.ui.screen.BadgesScreen
        ...
        setContent {
            ...
            NeuraTheme(
                ...
                val bottomBarRoutes = setOf(
                    NeuraDestinations.Home.route,
                    NeuraDestinations.Discover.route,
                    NeuraDestinations.Missions.route,
                    NeuraDestinations.Activity.route,
                    NeuraDestinations.Profile.route
                )
                        ...
                        NavHost(
                                ...
                                MyChallengesScreen(
                                    ...
                                    onEditChallenge = { challengeId ->
                                        navController.navigate(
                                            NeuraDestinations.EditChallenge.createRoute(
                                                challengeId
                                            )
                                        )
                                    },
                                    ...
                                    onOpenAuthor = { authorName ->
                                        navController.navigate(
                                            NeuraDestinations.AuthorDetails.createRoute(
                                                Uri.encode(
                                                    authorName
                                                )
                                            )
                            ...
                            composable(
                                ...
                                val challengeId = backStackEntry.arguments?.getInt("challengeId")
                                    ?: return@composable
                                val challenge = challengeViewModel.getUserChallengeById(challengeId)
                                    ?: return@composable
                            ...
                            composable(NeuraDestinations.ImportPackPreview.route) {
                                ...
                                if (pack != null) {
                                    ImportPackPreviewScreen(
                                        ...
                                        onImport = {
                                            val success =
                                                challengeViewModel.importChallengePack(pack)
                                            importStatus = if (success) {
                            ...
                            composable(NeuraDestinations.MyPacks.route) {
                                MyPacksScreen(
                                    ...
                                    onOpenPack = { localId ->
                                        navController.navigate(
                                            NeuraDestinations.PackDetails.createRoute(
                                                localId
                                            )
                                        )
                                    },
                            ...
                            composable(
                                ...
                                val localId = backStackEntry.arguments?.getLong("localId")
                                    ?: return@composable
                                val pack = challengeViewModel.getPackByLocalId(localId)
                                    ?: return@composable
                            ...
                            composable(
                                ...
                                val createdAt = backStackEntry.arguments?.getLong("createdAt")
                                    ?: return@composable
                                val pack = challengeViewModel.getFeaturedPackByCreatedAt(createdAt)
                                    ?: return@composable
                            ...
                            composable(NeuraDestinations.Badges.route) {
                                BadgesScreen(
                                    badgesSummary = challengeViewModel.getMissionBadgesSummary(
                                        userProfile.weeklyGoalSessions
                                    ),
                                    onBack = {
                                        navController.popBackStack()
                            ...
                            composable(
                                ...
                                val encodedAuthorName =
                                    backStackEntry.arguments?.getString("authorName")
                                        ?: return@composable
                                val authorName = Uri.decode(encodedAuthorName)

                                val isLocalProfile =
                                    challengeViewModel.isLocalProfileAuthor(authorName)
                                val profile =
                                    if (isLocalProfile) challengeViewModel.userProfile.collectAsState().value else null
